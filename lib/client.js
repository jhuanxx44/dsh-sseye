	...
	factory: (require) => {
		...
		*/
		...
		function Hero(props) {
			...
			}, (d.protocolGuessed ? "~" : "") + d.protocol) : null, d.source ? h("span", { className: "sseye-chip" }, d.source) : null, d.turn !== void 0 && d.turn !== null ? h("span", { className: "sseye-chip" }, "T" + d.turn + " · S" + d.step) : null, h("span", { className: "sseye-spacer" }), h("span", { className: "sseye-dim" }, fmtTime(d.startedAt))), d.baseURL !== void 0 ? h("div", { className: "sseye-hero-ep" }, String(d.baseURL)) : null, h("div", { className: "sseye-stats" }, stats), cacheBar);
		}
		function Detail() {
