	...
	factory: (require) => {
		...
		*/
		...
		function TurnGroup(props) {
			...
			}, h(Chevron, { open: isOpen }), h("span", { className: "sseye-tgh-title" }, title), h("span", { className: "sseye-chip" }, t("group.calls", { n: g.rows.length }) + (running ? t("group.running", { n: running }) : "")), h("span", { className: "sseye-tgh-prev" }, prev), h("span", { className: "sseye-tgh-agg" }, "in:" + inTok + " out:" + outTok + " · " + fmtDur(dur)), h("button", {
				className: "sseye-dl",
		...
		*/
		...
		function Panel() {
			...
			return h("div", {
				...
				ref: rootRef
			}, h("div", { className: "sseye-head" }, h("div", { className: "sseye-head-main" }, h("span", { className: "sseye-title" }, "SSEye"), h("span", { className: "sseye-count" }, t("panel.turns", { n: groups.length }) + " · " + t("group.calls", { n: items.length })), h("span", { className: "sseye-spacer" }), h("button", {
