	...
	factory: (require) => {
		...
		*/
		...
		function TurnGroup(props) {
			...
			}, h(Chevron, { open: isOpen }), h("span", { className: "sseye-tgh-title" }, title), h("span", { className: "sseye-chip" }, g.rows.length + " 次调用" + (running ? " · " + running + " 进行中" : "")), h("span", { className: "sseye-tgh-prev" }, prev), h("span", { className: "sseye-tgh-agg" }, "in:" + inTok + " out:" + outTok + " · " + fmtDur(dur))), isOpen ? h("div", { className: "sseye-steps" }, g.rows.map((it) => h(StepRow, {
				key: it.id,
				it,
				onSelect: () => {
		...
		function MessageView(props) {
			...
			return h("div", { className: "sseye-msg" + (props.isNew ? " sseye-msg-new" : "") }, h("span", { className: "sseye-chip" }, role), body);
		}
		...
		function Detail() {
			...
			if (d.source) meta.push(h("span", {
				key: "so",
				className: "sseye-chip"
			}, d.source));
			if (d.protocol) meta.push(h("span", {
				key: "pr",
				className: "sseye-chip",
				title: d.api ? d.api + (d.protocolGuessed ? "（按 provider 猜测）" : "（来自 provider 配置）") : void 0
			}, (d.protocolGuessed ? "~" : "") + d.protocol));
			if (d.turn !== void 0 && d.turn !== null) meta.push(h("span", {
				key: "ts",
				className: "sseye-chip"
			}, "T" + d.turn + " · S" + d.step));
			if (d.ttftMs !== void 0) meta.push(h("span", {
				key: "tt",
				className: "sseye-chip"
			}, "TTFT " + fmtDur(d.ttftMs)));
			if (d.durationMs !== void 0) meta.push(h("span", {
				key: "du",
				className: "sseye-chip"
			}, "总时长 " + fmtDur(d.durationMs)));
			meta.push(h("span", {
				key: "ch",
				className: "sseye-chip"
			}, d.chunks + " chunks"));
			...
			if (d.usage) kids.push(h("div", {
				key: "us",
				className: "sseye-sec"
			}, h("div", { className: "sseye-sec-title" }, "Usage"), copyableJson(d.usage)));
			kids.push(h("div", {
				key: "rq",
				className: "sseye-sec"
			}, h("div", { className: "sseye-sec-title" }, "请求 · " + String(req.provider || "") + "/" + String(req.model || "")), d.baseURL !== void 0 ? h("span", {
				className: "sseye-chip",
				title: "endpoint"
			}, String(d.baseURL)) : null, req.reasoningEffort !== void 0 ? h("span", { className: "sseye-chip" }, "effort " + String(req.reasoningEffort)) : null, req.temperature !== void 0 ? h("span", { className: "sseye-chip" }, "temp " + String(req.temperature)) : null, req.maxTokens !== void 0 ? h("span", { className: "sseye-chip" }, "max " + String(req.maxTokens)) : null));
