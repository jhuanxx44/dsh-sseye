	...
	factory: (require) => {
		...
		*/
		...
		function PolicyPanel() {
			...
			return h("div", { className: "sseye-policy" }, h("div", null, t("policy.sources"), srcLabels.map((kv) => h("label", { key: kv[0] }, h("input", {
				type: "checkbox",
			...
			}), kv[1]))), h("div", { style: { marginTop: "6px" } }, t("policy.fields"), fldLabels.map((kv) => h("label", { key: kv[0] }, h("input", {
				type: "checkbox",
			...
			}), kv[1]))), h("div", { style: { marginTop: "6px" } }, t("policy.capacity"), limLabels.map((it) => h("label", {
				key: it[0],
		...
		function Panel() {
			...
			return h("div", {
				...
				ref: rootRef
			}, h("div", { className: "sseye-head" }, h("span", { className: "sseye-title" }, "SSEye"), h("span", { className: "sseye-count" }, t("panel.turns", { n: groups.length }) + " · " + t("group.calls", { n: items.length })), h("button", {
				className: "sseye-btn",
			...
			}, store.onlyThisSession ? t("panel.thisSession") : t("panel.all")), h("span", { className: "sseye-spacer" }), h("button", {
				className: "sseye-btn",
				onClick: () => {
			...
			}, t("panel.close"))), store.showPolicy ? h(PolicyPanel) : null, h("div", { className: "sseye-body" }, h("div", { className: "sseye-listcol" }, groups.length === 0 ? h("div", { className: "sseye-empty" }, t("panel.empty")) : groups.map((g) => h(TurnGroup, {
				key: g.key,
				g
			})))));
		}
